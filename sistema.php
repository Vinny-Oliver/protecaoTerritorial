...
<head>
    ...
    <link rel="stylesheet" href="css/sistema" type="text/css">
    <link rel="stylesheet" href="css/estilos" type="text/css">

    <title>Sistema MVO</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#" style="font-size: 20px;">Início</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="mapa.html" style="font-size: 20px;">Mapa</a>
                        </li>
                        <li class="nav-item">
...
<br> <br> <br> <br> <br> <br> <br>
    ...
    ?>
    <br>
    <h2> Aguarde que um dos nossos representantes de vendas entrará em contato!</h2>
